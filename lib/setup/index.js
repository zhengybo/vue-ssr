...
class Setup {
  ...
  prod(){
    ...
    Object.assign(this.engine, {
      template : this.fs(dist, 'index.html'),
  ...
  template(){
    ...
    chokidar.watch(sounceTempPath).on('change', () => {
